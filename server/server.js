...
app.use(cors({
  origin: 'https://yop-client-39x7ljt1u-renies-projects-4a1d2a3c.vercel.app',  // 允许前端域名
...
const customHeadersAppLevel = function (req, res, next) {
  res.header('Access-Control-Allow-Origin', 'https://yop-client-39x7ljt1u-renies-projects-4a1d2a3c.vercel.app');
  res.header(
